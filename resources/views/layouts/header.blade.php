<header class="mb-6 p-6 rounded bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700">
    ...
    <div class="mt-3 flex flex-row gap-2">
        ...
        <a href="{{ url('feed') }}" class="text-black no-underline inline-flex" target="_blank">
            <x-icon.rss/>
        </a>
    </div>
</header>
