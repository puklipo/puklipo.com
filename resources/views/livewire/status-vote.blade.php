<div class="px-4 py-2 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-500 rounded-md shadow-sm  focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800">
    <div>
    ...
    <div class="mt-3 text-sm text-gray-700 dark:text-gray-300 tracking-widest">
        Laravel Tips botの投稿はOpenAI APIの出力です。当初はTipsを投稿させていましたが間違いが多すぎるので現在はリリースノートの日本語訳が主。
    </div>
